...
try:
    ...
    # Versions of the Odfpy >= v.1.3.0 are future compatible, unfortunately they produce assertion errors on file load.
    raise orm.except_orm('Warning', _('To be able to use OpenOffice documents please install "odfpy==0.9.6"'))
