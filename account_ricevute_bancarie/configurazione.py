...
class riba_configurazione(orm.Model):
    ...
    _columns = {
        ...
        'acceptance_account_id' : fields.many2one('account.account', "Conto Ri.Ba.", 
        ...
        'accreditation_account_id' : fields.many2one('account.account', "Conto Ri.Ba.", help='Account used when Ri.Ba. is accepted by the bank'),
