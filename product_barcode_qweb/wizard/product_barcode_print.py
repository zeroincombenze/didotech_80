...
class product_barcode_print(osv.osv_memory):
    ...
    _columns = {
        ...
        'labels_in_row': fields.integer('Labels in a row', help='How many labels in a row', readonly=True),
    }
    ...
    def print_report(self, cr, uid, ids, context=None):
        ...
        res = self.read(cr, uid, ids, ['qty', 'product_ids', 'labels_in_row'], context=context)
